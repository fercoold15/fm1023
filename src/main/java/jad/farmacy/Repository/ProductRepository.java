...
public interface ProductRepository extends CrudRepository<Product, Long> {
    ...
    @Query(value = "SELECT * FROM PRODUCTS LEFT JOIN STORES S on S.STORE_ID = PRODUCTS.STORE_ID LEFT JOIN SUPPLIERS S2 on S2.SUPPLIER_ID = PRODUCTS.SUPPLIER_ID WHERE STATUS=true",nativeQuery = true)
